...
const experiences = [
    {
        ...
        duration: "Present",
        description: "Developing robust web applications using Ruby on Rails, React.js, and Node.js. Designing scalable backend architectures and designing seamless user experiences.",
        skills: ["Ruby on Rails", "React.js", "Node.js", "MySQL", "Ant Design"]
    },
    {
        role: "Software Engineering Intern",
        company: "Jothi Software Private Ltd",
        duration: "Previous",
        description: "Assisted in building frontend interfaces using React and Bootstrap, collaborated within an Agile team environment, and implemented APIs.",
        skills: ["JavaScript", "HTML5", "CSS", "Bootstrap", "React"]
    }
];
